...
public class Disambiguator {
    ...
    public List<DomainTerm> disambiguate(List<DomainTerm> list) {

        for (DomainTerm domainTerm: list) {
            if(!isAmbiguous(domainTerm)) {
                ...
                DomainTerm leftDomainTerm = this.getClosestNeighborOnLeft(domainTerm, list);
                DomainTerm rightDomainTerm = this.getClosestNeighborOnRight(domainTerm, list);
